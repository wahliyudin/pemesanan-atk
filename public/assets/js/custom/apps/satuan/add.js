...
var KTModalsatuanAdd = function () {
                            ...
                            success: function (response) {
                                ...
                                Swal.fire({
                                    ...
                                    if (result.isConfirmed) {
                                        ...
                                        $('#kt_satuan_table').DataTable().ajax.reload();
                                    }
                                });
                            },
                        });
    ...
    return {
        ...
        init: function () {
            // Elements
            modal = new bootstrap.Modal(document.querySelector('#kt_modal_add_satuan'));

            form = document.querySelector('#kt_modal_add_satuan_form');
            submitButton = form.querySelector('#kt_modal_add_satuan_submit');
            cancelButton = form.querySelector('#kt_modal_add_satuan_cancel');
            closeButton = form.querySelector('#kt_modal_add_satuan_close');
