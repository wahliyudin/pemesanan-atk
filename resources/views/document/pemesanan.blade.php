...
<body>
    <table class="table table-bordered" style="border: solid 1px black; border-collapse: collapse;">
        ...
        <tfoot>
            <tr>
                <td style="border: solid 1px black; padding: 4px;" class="text-center" colspan="5">
                    Total
                </td>
                <td style="border: solid 1px black; padding: 4px;">
