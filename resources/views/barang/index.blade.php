        ...
        <div class=" container-xxl ">
            ...
            <div class="card">
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-title">
                        ...
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <!--end::Svg Icon--> <input type="text" data-kt-barang-table-filter="search"
                                class="form-control form-control-solid w-250px ps-15" placeholder="Search Barangs" />
                        </div>
                        <!--end::Search-->
                    </div>
                    <!--begin::Card title-->
                ...
                <div class="card-body pt-0">
                    ...
                    <!--begin::Table-->
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_barang_table">
                        <!--begin::Table head-->
                        <thead>
                            <!--begin::Table row-->
            ...
            <!--begin::Modals-->
            <!--begin::Modal - Barangs - Add-->
            <div class="modal fade" id="kt_modal_add_barang" tabindex="-1" aria-hidden="true">
                <!--begin::Modal dialog-->
                <div class="modal-dialog modal-dialog-centered mw-650px">
                    <!--begin::Modal content-->
                    <div class="modal-content">
                        <!--begin::Form-->
                        <form class="form" action="#" id="kt_modal_add_barang_form"
                            data-kt-redirect="{{ route('data-barang') }}">
                            <!--begin::Modal header-->
                            <div class="modal-header" id="kt_modal_add_barang_header">
                                <!--begin::Modal title-->
                                <h2 class="fw-bold">Add a Barang</h2>
                                <!--end::Modal title-->

                                <!--begin::Close-->
                                <div id="kt_modal_add_barang_close" class="btn btn-icon btn-sm btn-active-icon-primary">
                            ...
                            <div class="modal-footer flex-center">
                                <!--begin::Button-->
                                <button type="reset" id="kt_modal_add_barang_cancel" class="btn btn-light me-3">
                                    Discard
                                </button>
                                <!--end::Button-->

                                <!--begin::Button-->
                                <button type="submit" id="kt_modal_add_barang_submit" class="btn btn-primary">
