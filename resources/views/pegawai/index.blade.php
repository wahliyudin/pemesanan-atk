                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-title">
                        ...
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <!--end::Svg Icon--> <input type="text" data-kt-pegawai-table-filter="search"
                                class="form-control form-control-solid w-250px ps-15" placeholder="Search Pegawais" />
                        </div>
                        <!--end::Search-->
                    </div>
                    <!--begin::Card title-->
            ...
            <div class="modal fade" id="kt_modal_add_pegawai" tabindex="-1" aria-hidden="true">
                ...
                <div class="modal-dialog modal-dialog-centered mw-650px">
                    ...
                    <div class="modal-content">
                        <!--begin::Form-->
                        <form class="form" action="#" id="kt_modal_add_pegawai_form">
                            <!--begin::Modal header-->
                            <div class="modal-header" id="kt_modal_add_pegawai_header">
                                <!--begin::Modal title-->
                                <h2 class="fw-bold">Add a Pegawai</h2>
                                <!--end::Modal title-->

                                <!--begin::Close-->
                                <div id="kt_modal_add_pegawai_close" class="btn btn-icon btn-sm btn-active-icon-primary">
                                    ...
                                    <div class="col-md-6 fv-row">
                                        ...
                                        <div class="position-relative d-flex align-items-center">
                                            ...
                                            <input class="form-control form-control-solid ps-12"
                                                placeholder="Select a date" name="tanggal_lahir" />
                                            <!--end::Datepicker-->
                                        </div>
                                    </div>
                                    <!--end::Input group-->
                            ...
                            <div class="modal-footer flex-center">
                                <!--begin::Button-->
                                <button type="reset" id="kt_modal_add_pegawai_cancel" class="btn btn-light me-3">
                                    Discard
                                </button>
                                <!--end::Button-->

                                <!--begin::Button-->
                                <button type="submit" id="kt_modal_add_pegawai_submit" class="btn btn-primary">
...
@push('js')
    ...
    <script src="{{ asset('assets/js/custom/apps/pegawai/listing.js') }}"></script>
    <script src="{{ asset('assets/js/custom/apps/pegawai/add.js') }}"></script>
    <script>
        var dueDate = $(document.querySelector('[name="tanggal_lahir"]'));
        dueDate.flatpickr({
            dateFormat: "Y-m-d",
        });
    </script>
