        ...
        <div class=" container-xxl ">
            ...
            <div class="card">
                ...
                <div class="card-body pt-0">
                    <form action="{{ route('pemesanan.update', $pemesanan->kode) }}" method="POST" class="row">
                        @method('PUT')
                        @csrf
                        <div class="col-md-4">
                            <!--begin::Input group-->
                            <div class="fv-row mb-7">
                                ...
                                <div class="position-relative d-flex align-items-center">
                                    ...
                                    <input class="form-control form-control-solid ps-12" placeholder="Select a date"
                                        name="tanggal" value="{{ $pemesanan->tanggal }}" />
                                    <!--end::Datepicker-->
                                </div>
                            </div>
                        </div>
                                ...
                                <div id="kt_products">
                                    ...
                                    <div class="form-group">
                                        <div data-repeater-list="kt_products" class="d-flex flex-column gap-3">
                                            @forelse ($pemesanan->barangs as $item)
...
@push('js')
    ...
    <script src="{{ asset('assets/js/custom/apps/pemesanan/add.js') }}"></script>
    <script>
